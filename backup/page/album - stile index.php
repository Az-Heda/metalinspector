							...
							<?php
								if ($corrispondenza)
								{
									...
									if(!$db_selected)
											die("Errore nella selezione del DB".mysql_error());
									mysql_select_db("metal");
									$Query="select titolo as CTitolo
											from canzoni
											where album_id = $album_id_get
											order by canzone_id";
									$result=mysql_query($Query);
									if(!$result) {
											die("Errore della query:".mysql_error());
									...
									echo "\t\t\t\t\t".'<td id="get">'."\n";
									echo "\t\t\t\t\t\t".'<section>'."\n";
									echo "\t\t\t\t\t\t\t".'<div class="contenitore" style="box-shadow: none;">'."\n";
									echo "\t\t\t\t\t\t\t\t".'<header>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t".'<img src="img/album_'.$album_id[$key].'.jpg" width="250px"/>'."\n";
									echo "\t\t\t\t\t\t\t\t".'</header>'."\n";
									echo "\t\t\t\t\t\t\t\t".'<h3>'."\n";
									echo "\t\t\t\t\t\t\t\t\t".number_format($prezzo[$key], 2, '.', '').'€';
									echo "\t\t\t\t\t\t\t\t".'</h3>'."\n";
									...
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t".'<input type="hidden" name="album_id" value="'.$album_id_get.'"/>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t".'<input type="submit" value="Carrello" class="main"/>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t".'</form>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t".'</td>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t".'<td>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t".'<form method="post" action="php/aggiungi.php" style="margin-bottom: 0px;">'."\n";
									...
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t".'<input type="hidden" name="album_id" value="'.$album_id_get.'"/>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t".'<input type="submit" value="Lista desideri">'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t".'</form>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t".'</td>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t".'</tr>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t".'</tbody>'."\n";
									...
									echo "\t\t\t\t\t\t\t".'</section>'."\n";
									echo "\t\t\t\t\t\t".'</td>'."\n";
									echo "\t\t\t\t\t".'<td style="width: 421px; vertical-align: top;">'."\n";
									echo "\t\t\t\t\t\t".'<section>'."\n";
									echo "\t\t\t\t\t\t\t".'<div class="contenitore" style="box-shadow: none;">'."\n";
									echo "\t\t\t\t\t\t\t\t".'<header>'."\n";
									echo "\t\t\t\t\t\t\t\t\t".'<h2>Lista canzoni</h2>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t".'<ol class="uppercase" style="width: 100%; list-style-position: outside; list-style-type: decimal;">'."\n";
									...
									echo "\t\t\t\t\t\t\t\t\t\t\t".'<tr style="border: none; background-color: transparent;">'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t".'<td >'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t".'<form method="post" style="margin-bottom: 0px; width: 301px;">'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t".'<input type="hidden" name="lista" value="carrello"/>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t".'<input type="hidden" name="album_id" value="8"/>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t".'<input type="hidden" value="Carrello" class="main"/>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t\t".'</form>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t\t".'</td>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t\t".'</tr>'."\n";
									echo "\t\t\t\t\t\t\t\t\t\t".'</tbody>'."\n";
