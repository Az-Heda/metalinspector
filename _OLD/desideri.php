		...
		<header id="header">
			...
			<nav id="menu">
				<ul class="link">
					...
					<li><a href="desideri.php" class="active">Lista dei desideri</a></li>
				</ul>
			</nav>
		</header>
											...
											<tr  style="border: none; background-color: transparent;">
												<td>
													<form method="post">
														...
														<input type="submit" value="Sposta nel carrello" class="main"/>
													</form>
												</td>
												<td>
													<form method="post">
							...
							<tr>
								...
								<td>
									<form method="post">
										...
										<input type="submit" value="Sposta tutto" class="main right"/>
									</form>
								</td>
